			...
			<div id="table-content" style="width: 1200px;">
                           <?php include 'menu_gauche.php'; ?>
                                <div style="float: left;width: 740px;margin-right: 10px">
                                   ...
                                   <ul id="onglets">
                                  <li class="actif">Modifier ou supprimer des produits</li>
                                            ...
                                            foreach ($array as $arr)
                                            {
                                                ...
                                                echo '<td>';
                                                    ...
                                                    echo '<fieldset style="height: 60px ; width: 60px ; float:left; border-style: none; margin-right: 2px;">
                                                        ...
                                                        echo '<a href="modifier.php?id='.$arr[0].'" title="Modifier" class="icon-1 info-tooltip"></a>';
                                 ...
                                 <div class="item">
                                     <form >	
                                               <div class="control-group">
                                                     ...
                                                     <span class="add-on"><i class="icon-tags"></i></span><input  class="input-xlarge" type="text"  name="produit" id="produit">
                                                     </div>
                                               </div>
                                               <div class="control-group">
