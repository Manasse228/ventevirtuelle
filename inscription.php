                                ...
                                <fieldset style="float: left;width: 740px;border: solid black 1px;margin-right: 10px">
                                  <fieldset style="width: 740px;border: none;">
                                                ...
                                                <fieldset style="width: 60%;border: none;margin: auto;padding-bottom: 20px">
                                                    <h4>Faite votre choix pour continuer</h4>
                                                        <div class="btn-toolbar">
                                                        <a href="inscriptionVendeur.php" class="btn btn-large btn-primary">Je suis un vendeur</a>

                                                        <a href="inscriptionAcheteur.php" class="btn btn-large btn-danger">Je suis un acheteur</a>
                                                        </div>
                                                </fieldset>
                                  </fieldset>
                               </fieldset>
